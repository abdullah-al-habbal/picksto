...
final class PackagePresenter
{
    public function present(PackageModel $package): array
    {
        return [
            'id' => $package->id,
            'name' => $package->name,
            'nameAr' => $package->getTranslation('name', 'ar', false),
            'nameEn' => $package->getTranslation('name', 'en', false),
            'description' => $package->description,
            'descriptionAr' => $package->getTranslation('description', 'ar', false),
            'descriptionEn' => $package->getTranslation('description', 'en', false),
